import type { AskUserQuestionInput, AskUserQuestionItem, AskUserQuestionOption } from './types.ts'
...
// are dropped.
export function formatAskUserQuestionAnswer(answers: Array<{ header: string; values: string[] }>): string {
  return answers
