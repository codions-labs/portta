...
import { Terminal } from '@/modules/taskflow/components/terminal/terminal'
...
describe('Terminal reconnect', () => {
  ...
  it('reconnects immediately after a visible-tab socket close', () => {
    render(Terminal, { props: { worktree: 'feature/reconnect', terminalTheme: {} } })
  ...
  it('only retries once automatically for a visible-tab close', () => {
    render(Terminal, { props: { worktree: 'feature/retry-once', terminalTheme: {} } })
  ...
  it('waits for the tab to become visible before reconnecting hidden closes', () => {
    render(Terminal, { props: { worktree: 'feature/visible', terminalTheme: {} } })
