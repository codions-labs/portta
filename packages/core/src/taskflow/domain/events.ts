export type RuntimeEventType = 'agent_stopped' | 'agent_status_changed' | 'pr_opened' | 'runtime_error'
...
export type RuntimeEvent = AgentStoppedEvent | AgentStatusChangedEvent | PrOpenedEvent | RuntimeErrorEvent
