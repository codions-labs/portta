...
import { buildClaudeSessionFromText, encodeClaudeProjectDir, parseClaudeStreamLine } from '../adapters/claude-cli.ts'
      ...
      text: [
        ...
        JSON.stringify({
          ...
          message: {
            ...
            content: [{ type: 'tool_use', id: 'tool-1', name: 'Read', input: { file_path: '/tmp/foo.txt' } }],
          },
        }),
        JSON.stringify({
          type: 'user',
