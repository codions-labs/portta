import type { WorktreeMeta, WorktreeSnapshot } from 'portta-core/taskflow'
import { describe, expect, it } from 'vitest'
import type { ClaudeCliGateway, ClaudeCliSession, ClaudeCliSessionSummary } from '../adapters/claude-cli.ts'
import { ClaudeConversationService } from '../services/claude-conversation-service.ts'
