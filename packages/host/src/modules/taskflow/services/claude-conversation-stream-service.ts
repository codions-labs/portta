import type { ClaudeCliGateway, ClaudeCliRunHandle, ClaudeCliStreamMessage } from '../adapters/claude-cli.ts'
import type {
  AgentsConversationStreamSession,
  AgentsUiConversationMessageDeltaLivePayload,
  AgentsUiConversationMessageDraft,
  AgentsUiConversationMessageUpsertLivePayload,
} from './agents-ui-stream-service.ts'
...
export class ClaudeConversationStreamService {
  ...
  private readonly deps: ClaudeConversationStreamServiceDependencies
  constructor(deps: ClaudeConversationStreamServiceDependencies) {
    this.deps = deps
  }
  ...
  private broadcastUpsert(run: ActiveClaudeRun, message: AgentsUiConversationMessageDraft, orderKey: string): void {
