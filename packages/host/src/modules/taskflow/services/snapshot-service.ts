import type { CreatingWorktreeState, PrEntry, ProjectSnapshot, WorktreeSnapshot } from 'portta-core/taskflow'
import { compareWorktreeOrder, type WorktreeOrderFields } from 'portta-core/taskflow'
import type { RuntimeNotification } from './notification-service.ts'
...
export function buildProjectSnapshot(
  input: BuildWorktreeSnapshotsInput & {
    projectName: string
    mainBranch: string
