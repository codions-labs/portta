// Code review: one finder agent per review angle, an independent verifier per candidate finding
// (CONFIRMED / PLAUSIBLE / REFUTED), a gap-sweep at the higher levels, then a ranked, capped report.
// Run with: portta flow run workflow code-review [--input-json '{"target": "<ref|path|diff>", "level": "high|xhigh|max"}']
//       or: portta flow workflows run code-review [--args '{"target": "<ref|path|diff>", "level": "high|xhigh|max"}']
...
export const meta = {
  ...
  workspace: {
    ...
    reason: "Review should inspect the active branch and its uncommitted changes without modifying them.",
  },
  phases: [
