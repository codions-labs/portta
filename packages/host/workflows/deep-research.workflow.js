// Deep research: fan out web searches, deep-read the best sources, adversarially verify every
// claim with a 3-vote panel, synthesize a cited report.
// Run with: portta flow run workflow deep-research --input '<question>'
//       or: portta flow workflows run deep-research --args '"<question>"'
...
export const meta = {
  ...
  workspace: {
    ...
    reason: "Research is read-only and normally does not need an isolated Git worktree.",
  },
  phases: [
