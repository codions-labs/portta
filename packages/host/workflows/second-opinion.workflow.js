// Second opinion: ask both providers cheaply; if they agree, merge and return — if they
// disagree, escalate both to deep effort with the other's answer in hand, then adjudicate.
// Disagreement-triggered escalation: consensus-grade confidence at roughly half the cost of
// always running the full panel.
// Run with: portta flow run workflow second-opinion --input '<question>'
//       or: portta flow workflows run second-opinion --args '"<question>"'
...
export const meta = {
  ...
  workspace: {
    ...
    reason: "The comparison is read-only and normally needs no Git isolation.",
  },
  phases: [
